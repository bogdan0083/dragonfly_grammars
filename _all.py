...
alternatives.append(RuleRef(rule=_global.GlobalRule()))
...
if __name__ == '__main__':
    ...
    exec(compile(open('dragonfly_integration/kaldi_module_loader_plus.py', "rb").read(), 'dragonfly_integration/kaldi_module_loader_plus.py', 'exec'))
